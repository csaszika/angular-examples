...
export class NgTemplateOutletContainerComponent implements OnInit {
  ...
  heroes: Hero[] = [
    ...
    {name: 'deadpool', intelligence: 7, power: 7, reflex: 8, logo: 'assets/deadpool.png'},
    {name: 'ironman', intelligence: 9, power: 7, reflex: 7, logo: 'assets/ironman.svg'},
    {name: 'thor', intelligence: 6, power: 9, reflex: 7, logo: 'assets/thor.png'},
    ...
    {name: 'spiderman', intelligence: 7, power: 5, reflex: 9, logo: 'assets/spiderman.png'},
